...
# st.set_page_config(page_title="Summary AI")
st.set_page_config(page_title="Summary AI", page_icon="🤖", layout="centered", initial_sidebar_state = "auto")
hide_st_style = """
            <style>
...
# st.header("Summary AI")
st.header(":red[Summary AI] Pro 🔎",divider= 'rainbow')
    ...
    try:
        ...
        with st.spinner('Generating response...'):
            ...
            for i, company in enumerate(companies):
                ...
                prompt = f'''collect information of the company:{company} as much detail as possible. Please keep in mind Don't provide any wrong informations or doubt informations. Must check All the information should be correct.  
